...
import { LocationsAddDialogComponent } from './locations-add-dialog.component';
...
const TEST_DIRECTIVES = [LocationsAddDialogComponent, NoopComponent];

@NgModule({
  imports: [MatDialogModule, NoopAnimationsModule, FormsModule, AppMaterialModule],
  exports: TEST_DIRECTIVES,
  declarations: TEST_DIRECTIVES,
  entryComponents: [LocationsAddDialogComponent]
})
class LocationsAddDialogTestModule {}

describe('LocationsAddDialog', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [LocationsAddDialogTestModule],
      providers: [
        {
  ...
  it("should have correct content for 'Location'", () => {
    ...
    dialog.open(LocationsAddDialogComponent, config);
