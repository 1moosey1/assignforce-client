...
const TEST_DIRECTIVES = [LocationsDeleteDialogComponent, NoopComponent];

@NgModule({
  imports: [MatDialogModule, NoopAnimationsModule, FormsModule, AppMaterialModule],
  exports: TEST_DIRECTIVES,
  declarations: TEST_DIRECTIVES,
  entryComponents: [LocationsDeleteDialogComponent]
})
class LocationsDeleteDialogTestModule {}

describe('LocationsDeleteDialog', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [LocationsDeleteDialogTestModule],
      providers: [
        {
  ...
  it("should have correct content for 'Location'", () => {
    ...
    dialog.open(LocationsDeleteDialogComponent, config);
