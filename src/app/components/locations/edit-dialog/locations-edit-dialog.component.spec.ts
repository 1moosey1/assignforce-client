...
const TEST_DIRECTIVES = [LocationsEditDialogComponent, NoopComponent];

@NgModule({
  imports: [MatDialogModule, NoopAnimationsModule, FormsModule, AppMaterialModule],
  exports: TEST_DIRECTIVES,
  declarations: TEST_DIRECTIVES,
  entryComponents: [LocationsEditDialogComponent]
})
class LocationsEditDialogTestModule {}

describe('LocationsEditDialog', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [LocationsEditDialogTestModule],
      providers: [
        {
  ...
  it("should have correct content for 'Location'", () => {
    ...
    dialog.open(LocationsEditDialogComponent, config);
